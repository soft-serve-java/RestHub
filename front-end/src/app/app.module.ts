...
import {AdminComponent} from "./Administrator/admin-mainPage/admin.component";
...
@NgModule({
  ...
  providers: [WelcomeService, WaiterService,OrderStorageService, MenuService, StatusService, AuthGuardService, AuthService ,
    OrderService, HttpClient, AppService, AdminUserService, AdminDishService, AdminCategoryService, AdminRoleService,
    AdminUserService,
